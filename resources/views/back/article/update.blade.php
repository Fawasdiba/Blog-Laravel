        ...
        <div class="mt-3">
            ...
            <form action="{{ url('article/'. $article->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="desc" id="desc" cols="100" rows="25" class="form-control">{{ old('desc', $article->desc) }}</textarea>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <div class="mt-2">
                        ...
                        <br>
                        <img src="{{ asset('storage/back/' . $article->img) }}" alt="Gambar Lama" width="130px">
                    </div>
                </div>
